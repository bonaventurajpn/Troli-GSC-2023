...
import 'package:troli_gsc/app/modules/sign-upC/views/sign_up_c_view.dart';

import '../controllers/login_c_controller.dart';

class LoginCView extends StatefulWidget {
  const LoginCView({Key? key}) : super(key: key);

  @override
  State<LoginCView> createState() => _LoginCViewState();
}

class _LoginCViewState extends State<LoginCView> {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () => Get.offAll(() => SignUpCView()),
                  child: Text(
                    "Sign up",
                    textAlign: TextAlign.center,
            ...
            InkWell(
                ...
                child:
                    Text("<< Back", style: TextStyle(color: Color(0xFF362706))))
          ],
        ),
      ),
    );
