...
import 'package:troli_gsc/app/modules/homeC2/views/home_c2_view.dart';
import 'package:troli_gsc/app/modules/profileC/views/profile_c_view.dart';

import '../controllers/home_c_controller.dart';

class HomeCView extends GetView<HomeCController> {
  const HomeCView({Key? key}) : super(key: key);
  @override
              ...
              child: Column(children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      "| 081234567890",
                      style: TextStyle(color: Color(0xFF9A9696), fontSize: 15),
                    )
                  ],
                ),
                Container(
